    ...
    internal class VehicleInfo
    {
        public string Info<T>(T objVariable)
        {
            ...
            if (objVariable is Car)
            {
                ...
                info = $"{"Bil".PadRight(lessWidth)} {regNum.PadRight(width)} {color.PadRight(width)} {drive}";
            }
            if (objVariable is Bus)
            {
                ...
                info = $"{"Buss".PadRight(lessWidth)} {regNum.PadRight(width)} {color.PadRight(width)} {passengers}";
            }
            if (objVariable is Mc)
            {
                ...
                info = $"{"Mc".PadRight(lessWidth)} {regNum.PadRight(width)} {color.PadRight(width)} {make}";
            }
               return info;
        }
    }
